...
<Cards>
  <Card title="Fetchers" href="/docs/fetchers/overview">
    Connect to data sources (files, APIs, databases)
  </Card>
  <Card title="Chefs" href="/docs/chefs/overview">
    Preprocess text, markdown, tables, etc.
  </Card>
  <Card title="Chunkers" href="/docs/chunkers/overview">
    Split text with various strategies
  </Card>
  <Card title="Refineries" href="/docs/refinery/overview">
    Add overlap, embeddings, and more
  </Card>
  <Card title="Porters" href="/docs/porters/overview">
    Export to JSON, Datasets, etc.
  </Card>
  <Card title="Handshakes" href="/docs/handshakes/overview">
...
<Steps>
  <Step title="Explore Fetchers">
    Learn how to connect different data sources in [Fetchers](/docs/fetchers/overview)
  </Step>
  <Step title="Choose Your Chunker">
    Find the right chunking strategy in [Chunkers](/docs/chunkers/overview)
  </Step>
  <Step title="Enhance with Refineries">
    Improve chunk quality in [Refineries](/docs/refinery/overview)
  </Step>
  <Step title="Store Your Chunks">
    Ingest into vector databases with [Handshakes](/docs/handshakes/overview)
  </Step>
</Steps>
