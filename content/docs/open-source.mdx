...
<div align="center">
  <img
    src="https://raw.githubusercontent.com/chonkie-inc/chonkie/main/docs/assets/logo/chonkie_xray.png"
    alt="Chonkie Logo"
    height={120}
    width={200}
  />
...
<Cards>
  <Card title="Quick Start" href="/docs/chonkie/getting-started/quick-start">
    Install and create your first chunk in under 2 minutes
  </Card>
  <Card title="Installation Guide" href="/docs/chonkie/getting-started/installation">
    Detailed installation options for all features
  </Card>
  <Card title="Chunkers Overview" href="/docs/chonkie/chunkers/overview">
...
<Callout type="info">
  Need hosted chunking with zero setup? Check out our [Chunking API](/docs/chonkie/api-server/overview) for a managed solution.
</Callout>
