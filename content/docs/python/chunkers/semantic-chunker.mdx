...
<Callout type="info">For installation instructions, see the [Installation Guide](/python/installation).</Callout>
...
SemanticChunker supports multiple embedding providers through Chonkie's embedding system. See the [Embeddings Overview](/python/embeddings/overview) for more information.
