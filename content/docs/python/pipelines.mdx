...
<Cards>
  <Card title="Fetchers" href="/python/fetchers/overview">
    Connect to data sources (files, APIs, databases)
  </Card>
  <Card title="Chefs" href="/python/chefs/overview">
    Preprocess text, markdown, tables, etc.
  </Card>
  <Card title="Chunkers" href="/python/chunkers/overview">
    Split text with various strategies
  </Card>
  <Card title="Refineries" href="/python/refinery/overview">
    Add overlap, embeddings, and more
  </Card>
  <Card title="Porters" href="/python/porters/overview">
    Export to JSON, Datasets, etc.
  </Card>
  <Card title="Handshakes" href="/python/handshakes/overview">
...
<Steps>
  <Step title="Explore Fetchers">
    Learn how to connect different data sources in [Fetchers](/python/fetchers/overview)
  </Step>
  <Step title="Choose Your Chunker">
    Find the right chunking strategy in [Chunkers](/python/chunkers/overview)
  </Step>
  <Step title="Enhance with Refineries">
    Improve chunk quality in [Refineries](/python/refinery/overview)
  </Step>
  <Step title="Store Your Chunks">
    Ingest into vector databases with [Handshakes](/python/handshakes/overview)
  </Step>
</Steps>
