...
<Cards>
  <Card title="Quick Start" href="/docs/chonkie/oss/quick-start">
    Install and create your first chunk in under 2 minutes
  </Card>
  <Card title="Installation Guide" href="/docs/chonkie/oss/installation">
    Detailed installation options for all features
  </Card>
  <Card title="Chunkers Overview" href="/docs/chonkie/oss/chunkers/overview">
...
<Callout type="info">
  Need hosted chunking with zero setup? Check out our [Chunking API](/docs/chonkie/oss/api/overview) for a managed solution.
</Callout>
