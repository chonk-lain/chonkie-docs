...
<Cards>
  ...
  <Card title="TeraflopAIChunker" href="/docs/chunkers/teraflopai-chunker">
    Segments text using the TeraflopAI Segmentation API. Ideal for
    domain-specific segmentation such as legal documents.
  </Card>
  <Card title="TokenChunker" href="/docs/chunkers/token-chunker">
