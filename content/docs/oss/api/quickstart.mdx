...
The server starts on port `8000`. See the [Docker guide](/docs/chonkie/oss/api/docker) for the full `docker-compose.yml` and production setup.
...
<Cards>
  <Card title="All Endpoints" href="/docs/chonkie/oss/api/endpoints">
    Token, Sentence, Recursive, Semantic, Code, and refineries
  </Card>
  <Card title="Pipelines" href="/docs/chonkie/oss/api/pipelines">
    Save and execute reusable chunking workflows
  </Card>
  <Card title="Docker Deployment" href="/docs/chonkie/oss/api/docker">
