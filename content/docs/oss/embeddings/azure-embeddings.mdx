...
Embeddings require the `openai`, `azure-identity`, `numpy`, and `tiktoken` libraries. See the [Installation Guide](/docs/chonkie/oss/installation) for more information.
