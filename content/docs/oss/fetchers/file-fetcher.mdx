...
1. **Process** them with a [Chef](/docs/chonkie/oss/chefs/overview) to parse content
2. **Chunk** them with a [Chunker](/docs/chonkie/oss/chunkers/overview) to split into manageable pieces
3. **Refine** chunks with [Refineries](/docs/chonkie/oss/refinery/overview) for better quality

See the [Pipeline Guide](/docs/chonkie/oss/pipelines) for complete examples.
