...
<Cards>
  <Card title="Fetchers" href="/docs/chonkie/oss/fetchers/overview">
    Connect to data sources (files, APIs, databases)
  </Card>
  <Card title="Chefs" href="/docs/chonkie/oss/chefs/overview">
    Preprocess text, markdown, tables, etc.
  </Card>
  <Card title="Chunkers" href="/docs/chonkie/oss/chunkers/overview">
    Split text with various strategies
  </Card>
  <Card title="Refineries" href="/docs/chonkie/oss/refinery/overview">
    Add overlap, embeddings, and more
  </Card>
  <Card title="Porters" href="/docs/chonkie/oss/porters/overview">
    Export to JSON, Datasets, etc.
  </Card>
  <Card title="Handshakes" href="/docs/chonkie/oss/handshakes/overview">
...
<Steps>
  <Step title="Explore Fetchers">
    Learn how to connect different data sources in [Fetchers](/docs/chonkie/oss/fetchers/overview)
  </Step>
  <Step title="Choose Your Chunker">
    Find the right chunking strategy in [Chunkers](/docs/chonkie/oss/chunkers/overview)
  </Step>
  <Step title="Enhance with Refineries">
    Improve chunk quality in [Refineries](/docs/chonkie/oss/refinery/overview)
  </Step>
  <Step title="Store Your Chunks">
    Ingest into vector databases with [Handshakes](/docs/chonkie/oss/handshakes/overview)
  </Step>
</Steps>
