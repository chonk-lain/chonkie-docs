...
<Callout type="info">For installation instructions, see the [Installation Guide](/docs/chonkie/oss/installation).</Callout>
...
SemanticChunker supports multiple embedding providers through Chonkie's embedding system. See the [Embeddings Overview](/docs/chonkie/oss/embeddings/overview) for more information.
