...
<Cards>
  <Card title="OverlapRefinery" href="/docs/chonkie/oss/refinery/overlap-refinery">
    Refines chunks by adding overlapping chunks to the original chunk.
  </Card>
  <Card title="EmbeddingsRefinery" href="/docs/chonkie/oss/refinery/embeddings-refinery">
