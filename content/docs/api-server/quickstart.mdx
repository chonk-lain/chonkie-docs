...
The server starts on port `8000`. See the [Docker guide](/docs/chonkie/api-server/docker) for the full `docker-compose.yml` and production setup.
...
<Cards>
  <Card title="All Endpoints" href="/docs/chonkie/api-server/endpoints">
    Token, Sentence, Recursive, Semantic, Code, and refineries
  </Card>
  <Card title="Pipelines" href="/docs/chonkie/api-server/pipelines">
    Save and execute reusable chunking workflows
  </Card>
  <Card title="Docker Deployment" href="/docs/chonkie/api-server/docker">
