...
1. **Process** them with a [Chef](/docs/chonkie/chefs/overview) to parse content
2. **Chunk** them with a [Chunker](/docs/chonkie/chunkers/overview) to split into manageable pieces
3. **Refine** chunks with [Refineries](/docs/chonkie/refinery/overview) for better quality

See the [Pipeline Guide](/docs/chonkie/getting-started/pipelines) for complete examples.
