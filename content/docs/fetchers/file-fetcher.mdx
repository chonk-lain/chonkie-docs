...
1. **Process** them with a [Chef](/docs/chefs/overview) to parse content
2. **Chunk** them with a [Chunker](/docs/chunkers/overview) to split into manageable pieces
3. **Refine** chunks with [Refineries](/docs/refinery/overview) for better quality

See the [Pipeline Guide](/docs/getting-started/pipelines) for complete examples.
