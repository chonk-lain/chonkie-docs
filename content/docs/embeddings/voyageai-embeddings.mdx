...
Embeddings require the `voyageai`, `numpy`, and `tokenizers` libraries. See the [Installation Guide](/docs/chonkie/getting-started/installation) for more information.
