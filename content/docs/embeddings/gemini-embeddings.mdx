...
Gemini embeddings require the `google-genai` and `numpy` libraries. See the [Installation Guide](/docs/chonkie/getting-started/installation) for more information.
